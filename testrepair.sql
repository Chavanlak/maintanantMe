...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2025 at 12:45 PM
...
ALTER TABLE `message`
  ...
  ADD KEY `ReportProblemId` (`reportProblemId`),
  ADD KEY `id` (`id`);
...
--
ALTER TABLE `notirepair`
  MODIFY `NotirepairId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`id`) REFERENCES `reportproblem` (`reportProblemId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `notirepair`
  ...
  ADD CONSTRAINT `notirepair_ibfk_2` FOREIGN KEY (`equipmentId`) REFERENCES `eqipment` (`equipmentId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `notirepair_ibfk_3` FOREIGN KEY (`branchId`) REFERENCES `branch` (`branchId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
